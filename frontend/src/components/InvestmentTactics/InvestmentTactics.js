      ...
      <div>
        <div>
          <Jumbotron className={this.context.isDarkMode ? "bg-dark" : "bg-light"}>
            ...
            <p>
              Once you've made the choice to start investing your money, it's important to think about what you're going to
              put your money to work. A sound investment strategy is the cornerstone of a good portfolio.
          </p>
          </Jumbotron>
        </div>
        <div>
          <CardGroup>
            <Card className={this.context.isDarkMode ? "bg-dark" : "bg-light"}>
              <Card.Body>
                ...
                <Card.Text>
                  If you're an expert in a given field or keyed into how a certain market works, this strategy might be for you.
                  Famous investors, such as Michael Burry, focus on certain sectors such as water, and work hard to understand
                  the market.
                </Card.Text>
              </Card.Body>
              <Card.Footer>
                <ListGroup>
                  <ListGroup.Item action variant={this.context.isDarkMode ? "dark" : "light"}
            ...
            <Card className={this.context.isDarkMode ? "bg-dark" : "bg-light"}>
              <Card.Body>
                ...
                <Card.Text>
                  A conservative approach to investing focuses more on fixed-income securities and bonds, as opposed to
                  more volatile stocks and equities. This type of strategy helps protect investors from volatility and risk.
                </Card.Text>
              </Card.Body>
              <Card.Footer>
                <ListGroup>
            ...
            <Card className={this.context.isDarkMode ? "bg-dark" : "bg-light"}>
              <Card.Body>
                ...
                <Card.Text>
                  A moderately aggressive approach to investing is the most common approach among the average investors. It
                  revloves around a majority of funds being invested in stocks with some diversification among bonds and fixed-income securities.
                </Card.Text>
              </Card.Body>
              <Card.Footer>
                <ListGroup>
