...
const Budget = require(path.resolve(__dirname, "../database/models/budget"));
...
exports.getBudget = async function (req) {
  ...
  var spending = await Spending.findOne(
    {
      username: req.user.username,
      month: currDate.getMonth(),
      year: currDate.getFullYear(),
  ...
  return [
    ...
    {
      category: "Utilities",
      budgeted: budget.utilities,
      spent: spending.utilities,
    },
    {
      category: "Transportation",
      budgeted: budget.transportation,
      spent: spending.transportation,
    },
    ...
    {
      category: "Personal",
      budgeted: budget.personal,
      spent: spending.personal,
    },
    {
